...
export default function Product({
    ...
    const [isi, setType] = useState(existingType || '');
    ...
    async function createProduct(ev) {
        ...
        const data = { title, description, price, details, images, category, brand, stock, colors, isi };
        if (_id) {
        ...
        <div className="mx-auto max-w-2xl">
            <form onSubmit={createProduct} className="space-y-5">
                ...
                <div>
                    ...
                    <Link
                        href={'/categories'}
                        className="text-sm font-small text-blue-500 hover:text-primary-400"
                    >
                ...
                <div className="grid grid-cols-2 items-center my-4">
                    ...
                    <br></br>
                    <p className='font-small'>Contoh: 100/Box</p>
                ...
                <div className="grid grid-cols-2 items-center my-4">
                    ...
                    <br></br>
                    <p className='font-small'>Contoh: Box</p>
                    <div className="col-span-2 flex gap-2">
                        <input
                            type="text"
                            className="block w-full rounded-md border-gray-300 shadow-sm focus:border-primary-400 focus:ring focus:ring-primary-200 focus:ring-opacity-50 disabled:cursor-not-allowed disabled:bg-gray-50 disabled:text-gray-500 border p-3"
                ...
                <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                    ...
                    <div>
                        <label htmlFor="brand" className="block text-lg font-medium text-gray-900">
                            Select Brand
                        </label>
                        <Link
                            href={'/branded'}
                    ...
                    <div>
                        ...
                        <DatePicker
                            className="w-full rounded-lg border border-gray-200 p-3 text-sm mt-7"
                            selected={date}
